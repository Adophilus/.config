...
# . "$HOME\.config\komorebi\komorebi.generated.ps1"
...
# komorebic active-window-border-colour 255 255 255 --window-kind single
# komorebic active-window-border-colour 255 255 255 --window-kind stack
# komorebic active-window-border-colour 255 255 255 --window-kind monocle

# komorebic mouse-follows-focus disable
# komorebic identify-border-overflow-application exe vivaldi.exe
# komorebic identify-border-overflow-application exe Obsidian.exe
